...
//import IndexPageDao.ReducePageDao;
...
@WebServlet("/VipPageServlet")
public class VipPageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public VipPageServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html;charset=utf-8");
		   ...
		   String pc=request.getParameter("vippagenum");
		 
		 System.out.println(".............."+pc);
		
		 VIPPageDao tpd=new VIPPageDao();
		  entity.Page<Book>  pageBean=tpd.getVipBookData(Integer.parseInt(pc));
