...
@WebServlet(name="reservePageServlet",urlPatterns="/reservePageServlet")
public class reservePageServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ReservePageDao ld=new ReservePageDao();
		...
		{
			request.getRequestDispatcher("/reserveBook.jsp?action=success").forward(request, response);
