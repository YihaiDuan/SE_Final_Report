...
/**
 * Servlet implementation class ShowBookNewIndex
 */
@WebServlet("/ShowBookNewIndex")
public class ShowBookNewIndex extends HttpServlet {

	
	public ShowBookNewIndex() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 response.setContentType("text/html;charset=utf-8");
		  ...
		  BookDao bd=new BookDao();
		    ...
		    List<Book>  blist=bd.getBookAllTop();
