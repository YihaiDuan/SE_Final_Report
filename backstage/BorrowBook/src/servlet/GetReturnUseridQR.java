...
@WebServlet("/GetReturnUseridQR")
public class GetReturnUseridQR extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public GetReturnUseridQR() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		  ...
		  response.setContentType("text/html;charset=utf-8");
	       ...
	       if(blist!=null&&blist.size()>0)
	       {
	    	   ...
	    	   String time2=MD5.encrypt_5("00:00:00");
	           String fb=MD5.encrypt_10("fb_return");
	           
	           
	           json=fb+time2+userid;   
		...
		Path file2=new File(filePath+"/"+userid+"OKScan"+".png").toPath();
		 ...
		 String images=userid+"OKScan"+".png";
