...
@WebServlet("/DeleteCollectLibara")
public class DeleteCollectLibara extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public DeleteCollectLibara() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 response.setContentType("text/html;charset=utf-8");
	      ...
	      cd.deleteCollect(Integer.parseInt(id));
	      
	      
   CollectDao cdo=new CollectDao();
	      
	      List<Collect>  clist=cdo.getCollectByUserid(userid);
