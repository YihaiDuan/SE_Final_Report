...
@WebServlet("/UpMyUserImages")

public class UpMyUserImages extends HttpServlet 
{
public UpMyUserImages() {
	super();
}
...
public void doPost(HttpServletRequest request, HttpServletResponse response)
  ...
  try {
   ...
   //String filename=tempFile.getFileName();
        ...
        User u=new User();
        u.setUserid(userid);
        u.setUserimages("http://localhost：8080/BorrowBook/images/"+userid+time+"."+ext);
        
       ud.UpdatePersonImages(u);
