...
/**
 * Servlet implementation class DeleteAdmire
 */
@WebServlet("/DeleteAdmire")
public class DeleteAdmire extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.setContentType("application/json;charset=utf-8"); 
		  ...
		  //点赞撤销
		  ad.deleteAdmire(userid, Integer.parseInt(commentid));
