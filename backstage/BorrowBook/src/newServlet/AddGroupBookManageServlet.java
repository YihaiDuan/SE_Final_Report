...
@WebServlet(name="AddGroupBookManageServlet",urlPatterns="/AddGroupBookManageServlet")
public class AddGroupBookManageServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AddGroupBookManageServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		groupbook = groupbookdao.SaveGroupBook(groupbook);
		...
		str.append("groupbookid:\""+groupbook.getId());
		str.append("\"}");
