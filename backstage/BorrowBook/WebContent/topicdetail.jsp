  ...
  <body>
   <div id="content">
     <%
                  ...
                  //  List<TopicBook> list = new ArrayList<TopicBook>(topic.getTopicBook());
     %>
		...
		<div style="padding:0 20px;">
		 <div class="row">
               ...
               <a href="specialbookdeatil.jsp?id=<%=id%>" class="layui-btn layui-btn-radius" style="letter-spacing:2px;height:32px;line-height:32px;">专题图书信息</a> 
           </div> 
			<table class="layui-table">
				...
				<thead>
				    ...
				    <tbody>
                                   ...
                                   <td style="text-align:center;"><%=topic.getDate()%></td>
                                   </tr>
                                   <tr>
                                   <td style="text-align:center">标题</td>
                                   <td style="text-align:center;"><%=topic.getTopicname()%></td>
                                   </tr>
                                    <tr>
                                   <td style="text-align:center">内容</td>
                                   <td style="text-align:center;"><%=topic.getDescrib()%></td>
                                   </tr>
                                    <tr>
                                   <td style="text-align:center">图片</td>
                                   <td style="text-align:center;"><img src="<%=topic.getTopicimg()%>" class="topicimages"></img></td>
                                   </tr>
                                    <tr>
                                   <td style="text-align:center">显示</td>
                                   <td style="text-align:center;">       	
                                   <div class=" layui-form layui-form-item" style="margin-bottom:0;">
                                   <input type="checkbox" name="" title="显示" style="height:28px;line-height:26px" disabled="disabled"
                                     <%
